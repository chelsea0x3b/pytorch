...
def repurposeOps(op_db, base_test_name, derived_test_name):
    repurposedOps = []
    for opinfo in op_db:
        ...
        repurposedOps.append(opinfo_copy)
    return repurposedOps
...
class TestMultiThreadedDTensorOps(DTensorOpTestBase, TestDTensorOps):
    _op_db = repurposeOps(op_db, "TestDTensorOps", "TestMultiThreadedDTensorOps")
...
class TestLocalDTensorOps(TestDTensorOps):
    _op_db = repurposeOps(op_db, "TestDTensorOps", "TestLocalDTensorOps")
